...
\[\begin{tikzcd}
	...
	{U\cap V} &&&& X \\
	&& V
	\arrow["{j_1}", hook, from=1-3, to=2-5]
	\arrow["{i_1}", hook, from=2-1, to=1-3]
	\arrow["{i_1}"', hook, from=2-1, to=3-3]
	\arrow["{j_2}"', hook, from=3-3, to=2-5]
\end{tikzcd}\]
...
\[\begin{tikzcd}
	&& {\pi_1(U,p)} && \\
	{\pi_1(U\cap V,p)} &&&& {\pi_1(X,p)} \\
	&& {\pi_1(V,p)}
	\arrow["{(j_1)_\star}", from=1-3, to=2-5]
	\arrow["{(i_1)_{\ast}}", from=2-1, to=1-3]
	\arrow["{(i_1)_{\star}}"', from=2-1, to=3-3]
	\arrow["{(j_2)_\star}"', from=3-3, to=2-5]
\end{tikzcd}\]
\begin{theorem}
